...
/*
    JDBC class is used to interact with the MySQL database to perform activities such as retrieving and updating out db
 */
public class MyJDBC {
    //database configurations
    private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/bankapp";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "Student10!";

    // if valid returns an object with the user's information
    ...
    //true - update to db was successful
    //false - update to db was unsuccessful
    ...
    //false - transfer was unsuccessful
